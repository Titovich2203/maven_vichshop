...
public final class CommandePdf {
    ...
    private static void addTitlePage(Document document)
        ...
        preface.add(new Paragraph("Bon de commande ", titledFont));
    ...
    public static void imprimerPdf(BonCommande bon)
    {
        setCommande(bon);
        FILE = "impression/commandes/"+bon.getNumero()+".pdf";

        try {
            Document document = new Document();
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(FILE));
            if(bon.getEtatBon().getLibelle().equals("NON_VALIDE"))
