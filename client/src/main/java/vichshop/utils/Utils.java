...
public class Utils {
    ...
    public static void showPopup(String title, String header, String popup) throws IOException {
        ...
        a.setTitle(title);
        a.setHeaderText(header);
        DialogPane content = (DialogPane) FXMLLoader.load(LoadPopup.class.getResource("/vichshop/view/popup/" +popup));
    ...
    public static FXMLLoader getLoader(String title, String header, String popup) throws IOException {
        ...
        fl = new FXMLLoader(LoadPopup.class.getResource("/vichshop/view/popup/" +popup));
